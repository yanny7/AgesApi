...
import static com.yanny.ages.api.manual.ConfigHolder.RECIPE;
import static com.yanny.ages.api.manual.ConfigHolder.SCALE;
...
public class RecipeWidget extends MarginWidget {
    ...
    private List<String> getText(@Nonnull ItemStack ingredient) {
        List<ITextComponent> list = ingredient.getTooltip(Minecraft.getInstance().player, ITooltipFlag.TooltipFlags.NORMAL);
